...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        notificationManager = notificationManager.from(this);
    ...
    public void sendOnChannel1(View view) {
        System.out.println("CHANnnnnnnnel      1");
    ...
    public void sendOnChannel2(View view) {
        String title = (String) editTextTitle.getText().toString();
        String message = (String) editTextMessage.getText().toString();
